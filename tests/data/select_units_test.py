...
class TestSelectUnits(unittest.TestCase):
    ...
    def test_level(self):
        ...
        expected = np.array([
            ...
            0.00000000, 0.05541981, 0.66002013, 1.22292388, 1.76497934, 2.26533823,
            2.75527297, 3.22435943, 3.68302174, 4.13125991, 3.49720522, 4.55864979,
            4.98603967, 5.40300541
        ])
        self.assertTrue(np.all(np.abs(selected - expected) < 0.0000001))
