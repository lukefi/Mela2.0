...
from lukefi.metsi.core.generators import Event, First
    ...
    simulation=Simulation(
        instructions=[
            SimulationInstruction(
                ...
                events=[
                    First([
                        Event(treatment=do_nothing,
                              static_parameters={"n": 1},
                              preconditions=[RelativeTimePoints([1])],
                              tags={"first_type"}),
                        Event(treatment=do_nothing,
                              static_parameters={"n": 3},
                              preconditions=[RelativeTimePoints([3])],
                              tags={"third_type"}),
                        Event(treatment=do_nothing,
                              static_parameters={"n": 4},
                              preconditions=[RelativeTimePoints([4])],
                              tags={"fourth_type"}),
                        Event(treatment=do_nothing,
                              static_parameters={"n": 5},
                              preconditions=[RelativeTimePoints([5])],
                              tags={"fifth_type"}),
                    ])
                ]
            )
