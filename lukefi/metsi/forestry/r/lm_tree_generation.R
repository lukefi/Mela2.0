...
#metsi
#generoi.kuvauspuut<-function(ositerivi,lukupuut,n,tapa,HDmod.=HDmod,hmalli=1,shdef=4,shinit=0.1,width=2,minshape=2,mind=0,q=1.5,r1=4,r2=9.00,d1=4.5,d2=9.5,skaalaus=1,plos=NA,nmax=2000,
#		                     dhfactor=c(1,1)) {

generoi.kuvauspuut<-function(ositerivi,lukupuut,path="",n,tapa,hmalli=1,shdef=5,shinit=0.1,width=2,minshape=2,mind=0,q=1.5,r1=4,r2=9.00,d1=4.5,d2=9.5,skaalaus=1,plos=NA,nmax = 2000,
		                     dhfactor=c(1,1)) {
   #metsi
   if (!exists("HDmod")) {
   ...
   sol<-fitRMLVMI(lukupuut$lpm,Dcor,Dtype="B",init=shinit,trace=FALSE,minshape=minshape,shdef=shdef,q=q,r1=r1,r2=r2,d1=d1,d2=d2,rho=1.6) # rho= muotoparametrin harhan korjausparametri
