...
class CrownClass(StrEnum):
    UNSET = ""
    CROWNLESS = "0"
    DOMINANT_TREE_IN_DOMINANT_TREE_STOREY = "2"
    INTERMEDIATE_TREE_IN_DOMINANT_TREE_STOREY = "3"
    SUPPRESSED_TREE_IN_DOMINANT_TREE_STOREY = "4"
    UNDER_STOREY_TREE = "5"
    DOMINANT_TREE_IN_OVER_STOREY = "6"
    INTERMEDIATE_OR_SUPPRESSED_TREE_IN_OVER_STOREY = "7"
    RETENTION_DOMINANT_TREE_IN_DOMINANT_TREE_STOREY = 'B'
    RETENTION_INTERMEDIATE_TREE_IN_DOMINANT_TREE_STOREY = 'C'
    RETENTION_SUPPRESSED_TREE_IN_DOMINANT_TREE_STOREY = 'D'
