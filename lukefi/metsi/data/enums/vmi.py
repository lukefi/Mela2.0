...
class VmiTreeCategory(Enum):
    SMALL_TREE = '0'
    WASTE_TREE = '1'
    GOOD_PULP_WOOD_TREE = '2'
    REGULAR_PULP_WOOD_TREE = '3'
    DEFECTIVE_PULP_WOOD_TREE = '4'
    GOOD_SAW_LOG_TREE = '5'
    DEFECTIVE_GOOD_SAW_LOG_TREE = '6'
    SAW_LOG_TREE = '7'
    DEFECTIVE_SAW_LOG_TREE = '8'
    LARGE_PULP_WOOD_TREE = '9'
    USABLE_STANDING_DEAD_TREE = 'A'
    USABLE_FALLEN_DEAD_TREE = 'B'
    DRY_STANDING_DEAD_TREE = 'C'
...
class VmiCuttingMethod(Enum):
    ...
    SPECIAL_CUTTING = 'A'
    HIGH_GRADING_SELECTIVE_CUTTING = 'B'
    UPPER_LAYER_FIRST_THINNING = 'C'
    UPPER_LAYER_OTHER_THINNING = 'D'
    SELECTIVE_LOGGING = 'E'
    GAP_FELLING = 'P'
