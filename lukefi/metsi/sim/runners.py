...
Runner = Callable[[list[T], SimConfiguration[T], sqlite3.Connection], dict[str, list[SimulationPayload[T]]]]
...
def run_full_tree_strategy(payload: SimulationPayload[T],
                           ...
                           db: sqlite3.Connection) -> list[SimulationPayload[T]]:
...
def default_runner(units: list[T],
                   ...
                   db: sqlite3.Connection) -> dict[str, list[SimulationPayload[T]]]:
